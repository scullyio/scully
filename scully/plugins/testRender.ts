import { HandledRoute, registerPlugin, renderRoute, routeRenderer, Deferred, scullyConfig } from '@scullyio/scully';
...
registerPlugin('scullySystem', routeRenderer, async (route: HandledRoute) => {
