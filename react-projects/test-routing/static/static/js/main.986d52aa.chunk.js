  ...
  [0],
  {
    ...
    74: function(e, t, n) {
      ...
      var a = n(2),
        ...
        y = (function() {
          function e(t) {
            if ((Object(b.a)(this, e), t && 'object' !== typeof t)) throw d;
            (this.state = t || null),
              (this.script = Object(E.b)() ? this.document.createElement('script') : {}),
              console.log('isScullyRunning', Object(E.b)()),
              console.log('isScullyGenerated', Object(E.a)());
          }
          return (
            Object(p.a)(e, [
              {
                ...
                value: function(e) {
                  ...
                  (this.state = Object(f.a)({}, this.state, {}, e)),
                    (this.script.textContent = "window['"
                      ...
                      .concat(_)),
                    Object(E.b)() && this._injectScript();
                },
              },
              {
                key: 'getState',
                value: function(e) {
                  if (!this.state.hasOwnProperty(e)) throw j;
                  return this.state[e];
                },
              },
              {
                key: '_injectScript',
                value: function() {
                  this.script.setAttribute('id', O), this.document.appendChild(this.script);
                },
              },
            ]),
            e
          ...
          r.a.createElement(
            ...
            e
              ? r.a.createElement(
                  ...
                  b && r.a.createElement('h2', null, ''.concat(b.name, ' - ').concat(b.email)),
...
//# sourceMappingURL=main.986d52aa.chunk.js.map
