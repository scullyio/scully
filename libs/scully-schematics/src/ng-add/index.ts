...
const importScullyModule = (project: string) => (
  tree: Tree,
...
const addScullyModule = (project: string) => (
  tree: Tree,
  context: SchematicContext
) => {
...
const addPolyfill = (project: string) => (
  tree: Tree,
  context: SchematicContext
) => {
  let polyfills = tree
...
const runScullySchematic = (options: Schema) => (
  tree: Tree,
  context: SchematicContext
) => {
  const nextRules: Rule[] = [];
