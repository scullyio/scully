...
(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  ['user-user-module'],
  {
    ...
    \*********************************************/
      ...
      /***/
      function srcAppUserPostPostComponentTs(module, __webpack_exports__, __webpack_require__) {
        'use strict';
        ...
        var PostComponent =
          /*#__PURE__*/
          (function() {
            function PostComponent(route, http, transferState) {
              var _this = this;
              ...
              this.postId$ = this.route.params.pipe(
                ...
                Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__['map'])(function(val) {
              ...
              this.apiPosts$ = this.postId$.pipe(
                Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__['switchMap'])(function(id) {
                  return _this.http.get('https://jsonplaceholder.typicode.com/posts/'.concat(id)).pipe(
              ...
              this.post$ = Object(_scullyio_ng_lib__WEBPACK_IMPORTED_MODULE_3__['isScullyGenerated'])()
                ...
                : this.apiPosts$.pipe(
                    Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__['tap'])(function(post) {
                      return _this.transferState.setState('post', post);
                    })
                  );
    ...
    \***********************************************/
      ...
      /***/
      function srcAppUserPostsPostsComponentTs(module, __webpack_exports__, __webpack_require__) {
        'use strict';
        ...
        var PostsComponent =
          /*#__PURE__*/
          (function() {
            function PostsComponent(route, http, transferState) {
              var _this2 = this;
              ...
              this.userId$ = this.route.params.pipe(
                ...
                Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__['filter'])(function(val) {
                  return ![undefined, null].includes(val);
                }),
                Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__['map'])(function(val) {
                  return parseInt(val, 10);
                }),
              ...
              this.apiPosts$ = this.userId$.pipe(
                Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__['switchMap'])(function(id) {
                  return _this2.http
                    .get('https://jsonplaceholder.typicode.com/posts?userId='.concat(id))
                    .pipe(
              ...
              this.posts$ = Object(_scullyio_ng_lib__WEBPACK_IMPORTED_MODULE_1__['isScullyGenerated'])()
                ...
                : this.apiPosts$.pipe(
                    Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__['tap'])(function(posts) {
                      return _this2.transferState.setState('posts', posts);
                    })
                  );
            }
    ...
    \****************************************/
      ...
      function srcAppUserUserComponentTs(module, __webpack_exports__, __webpack_require__) {
        ...
        var UserComponent =
          /*#__PURE__*/
          (function() {
            function UserComponent(route, http, transferState) {
              var _this3 = this;
              ...
              this.next$ = this.userId$.pipe(
                Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__['map'])(function(id) {
                  return Math.min(+id + 1, 10);
                })
              );
              this.prev$ = this.userId$.pipe(
                Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__['map'])(function(id) {
                  return Math.max(1, +id - 1);
                })
              );
              this.apiUser$ = this.userId$.pipe(
                Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__['switchMap'])(function(id) {
                  return _this3.http.get('https://jsonplaceholder.typicode.com/users/'.concat(id)).pipe(
                    Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__['catchError'])(function() {
                      return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__['of'])({
                        id: id,
                        name: 'not found',
              ...
              this.user$ = Object(_scullyio_ng_lib__WEBPACK_IMPORTED_MODULE_1__['isScullyGenerated'])()
                ...
                : this.apiUser$.pipe(
                    Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__['tap'])(function(user) {
                      return _this3.transferState.setState('user', user);
                    })
                  );
            }
    ...
    \***********************************************/
      ...
      function srcAppUserUsersUsersComponentTs(module, __webpack_exports__, __webpack_require__) {
        ...
        var UsersComponent =
          /*#__PURE__*/
          (function() {
            function UsersComponent(http, transferState) {
              var _this4 = this;
              ...
              this.users$ = Object(_scullyio_ng_lib__WEBPACK_IMPORTED_MODULE_1__['isScullyGenerated'])()
                ...
                : this.apiUsers$.pipe(
                    Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__['tap'])(function(user) {
                      return _this4.transferState.setState('users', user);
                    })
                  );
            }
